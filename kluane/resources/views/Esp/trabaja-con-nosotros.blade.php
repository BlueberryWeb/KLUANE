...
<head>
    ...
    <title>KLUANE | TRABAJA CON NOSOTROS </title>
</head>
<body>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-7 p-0 box-work">
                    <div class="mx-3">
                        <div data-aos="fade-right" data-aos-delay="1000" data-aos-duration="800" class="bg-bco py-5">
                            <div class="mx-5">
                                <h1 class="black txt-gris display-5">TRABAJA</h1>
                                <h1 class="black txt-azul display-3">CON NOSOTROS</h1>
                                <div class="d-none d-sm-none d-md-block">
                                    <p class="txt-gris regular"><b class="bold">Nos preocupamos </b>por nuestros colaboradores y 
                                        <b class="bold"> brindamos un ambiente</b></p>
                                    <p class="txt-gris regular"><b class="bold">de trabajo seguro y saludable</b> basado en brindar oportunidades para todos y  </p>
                                    <p class="txt-gris regular">desarrollar a nuestra gente para ayudarlos a alcanzar sus <b class="bold"> metas.</b></p>
                                </div>
                                <div class="d-block d-sm-block d-md-none">
                                    <p class="txt-gris regular"><b class="bold">Nos preocupamos  </b>por nuestros colaboradores y 
                                        <b class="bold">brindamos un ambiente de trabajo seguro y saludable</b>
                                        basado en brindar oportunidades para todos y desarrollar a nuestra gente para ayudarlos a alcanzar sus<b class="bold"> metas.</b>
                                    </p>
                                </div>  
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-10">
                <div class="text-center mb-4">
                    <img src="https://res.cloudinary.com/di4ezko9l/image/upload/v1675879562/img/logo-kluane-azul_hupqix.png" alt="KLUANE DRILLING LTD" class="img-fluid mb-3"/>
                    <h1 class="regular txt-azul"><b class="bold">COMPLETA </b>EL SIGUIENTE FORMULARIO Y EN</h1>
                    <h1 class="regular txt-azul"> BREVE NOS PONDREMOS <b class="bold">EN CONTACTO CONTIGO</b></h1>
                </div>
                    ...
                    <div class="bg-azul p-5">
                        <div class="mb-3 row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    <label for="name" class="form-label bold">NOMBRE</label>
                                    <input type="text" class="form-control" id="name" name="name" required/>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    <label for="lname" class="form-label bold">APELLIDOS</label>
                        ...
                        <div class="mb-3 row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    <label for="email" class="form-label bold">CORREO ELECTRÓNICO</label>
                                    <input type="email" class="form-control" id="email" name="email" required/>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    <label for="phone" class="form-label bold">TELÉFONO</label>
                        ...
                        <div class="mb-3 row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    <label for="name" class="form-label bold">PAÍS</label>
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="mb-3">
                                    <label for="lname" class="form-label bold">CIUDAD</label>
                                    <input type="text" class="form-control" id="lname" name="lname" required/>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="position" class="form-label bold">POSICIÓN DE INTERÉS</label>
                            <input type="text" class="form-control" id="position" name="position" required/>
                        </div>
                        <div class="mb-3">
                            <label for="message" class="bold">MENSAJE</label>
